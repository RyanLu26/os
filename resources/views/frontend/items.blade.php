		...
		$(document).ready(function(){
			...
			$.post("{{route('getitems')}}",{sid:id},function(res){
				...
				$.each(res,function(i,v){
					...
					<a href="" class="btn btn-info cart-btn" data-id="${v.id}" data-name="${v.name}" data-photo="${v.photo}" data-price="${v.price}" data-discount="${v.discount}" data-qty="${v.qty}">Add to Cart</a>
